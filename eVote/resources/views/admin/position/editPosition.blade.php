                ...
                <div class="col-lg-6">
                                                <div class="card">
                                                    <div class="card-header">
                                                       Modifiko <strong>{{$position->position}}</strong> 
                                                    ...
                                                    @endif
                                                        <form action="{{url('positions/'.$position->id)}}" method="post" class="form-horizontal">
                                                         @csrf
                                                         @method('put')
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="position" class=" form-control-label">Pozita <span class="text-danger">*</span></label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="position" name="position" placeholder="" value="{{$position->position}}" class="form-control">
                                                                @error('position')
