                ...
                <div class="col-lg-6">
                                                <div class="card">
                                                    <div class="card-header">
                                                       Shto <strong>lloje te zgjedhjeve</strong> 
                                                    ...
                                                    @endif
                                                        <form action="{{url('election-types')}}" method="post" class="form-horizontal">
                                                         @csrf
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="type" name="type" placeholder="" class="form-control">
                                                                @error('type')
