            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    @endif
                                                        <form action="{{url('numbers/'.$number->id)}}" method="post" class="form-horizontal">
                                                         @csrf
                                                         @method('put')
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="number" class=" form-control-label">Numri <span class="text-danger">*</span></label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="number" name="number" placeholder="" value="{{$number->number}}" class="form-control">
                                                                @error('number')
