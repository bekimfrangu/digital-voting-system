            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    @endif
                                                        <form action="{{url('regions')}}" method="post" class="form-horizontal">
                                                         @csrf
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="region" class=" form-control-label">Rajoni <span class="text-danger">*</span></label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="region" name="region" placeholder="" class="form-control">
                                                                @error('region')
